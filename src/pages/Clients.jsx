        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
          {clientsData.map((client) => (
            <div 
              ...
              className="group p-8 rounded-3xl bg-zinc-50 border border-zinc-200 hover:border-brand-purple/40 hover:shadow-lg transition-all duration-300 flex flex-col justify-between h-72 cursor-pointer"
              role="button"
              tabIndex={0}
              onKeyDown={(e) => {
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <div className="w-9 h-9 rounded-full bg-white border border-zinc-200 flex items-center justify-center text-zinc-400 group-hover:text-brand-purple group-hover:border-brand-purple/40 transition">
              ...
              <div>
                ...
                <div className="mt-4 pt-3 border-t border-zinc-200 flex items-center justify-between text-xs font-mono">
